...
class ProdukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('foto')) {
                ...
                $newImageName = 'thumbnail_' . time() . '.' . $imageExtension;
                $fotoPath = 'produk_thumbnail/' . $newImageName;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $fotoPath = $produk->fotoProduk; // Keep the old photo path
            ...
            $produk->fotoProduk = $fotoPath; // Update the photo path
            $produk->save();
