        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control select2 form-select" data-placeholder="Pilih" id="kategori">
                ...
                <div class="form-group">
                    ...
                    <input id="hargaInput" class="form-control" placeholder="Masukan Harga Produk" name="harga" type="text">
                    @error('harga')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
