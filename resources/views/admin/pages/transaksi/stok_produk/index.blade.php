...
@section('script')
    ...
    // Menggunakan event delegation untuk menangani click event pada tombol changeStatusBtn
    $(document).on('click', '.changeStatusBtn', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        var changeStatus = $('#changeStatus' + id);
        var statusText = $(this).text().trim() === 'Aktif' ? 'Data akan diubah menjadi Nonaktif!' : 'Data akan diubah menjadi Aktif!';
