        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <form method="GET" action="{{ url('/') }}">
                    <select name="kategori" onchange="this.form.submit()"class="form-control">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            @if (empty(Auth::user()))
                                <a onclick="cekAuth()" class="btn btn-light shadow">
                                    <i class="fa fa-cart-shopping"></i> Keranjang
                                </a>
                                <a onclick="cekAuth()" class="btn btn-primary shadow" style="float: right">
                                    <i class="fa fa-edit"></i> Pesan
                                </a>
                            @else
                                <a href="{{ url('/keranjang/' . $item['id']) }}" class="btn btn-light shadow">
                                    <i class="fa fa-cart-shopping"></i> Keranjang
                                </a>
                                <a onclick="detailProduk('{{ $item['id'] }}')" class="btn btn-primary shadow"
