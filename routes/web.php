...
// LandingPage
Route::get('/keranjang/{id}/detail', [StokProdukController::class, 'detailProduk']);
Route::post('/keranjang/clear', [AppController::class, 'clear'])->name('keranjang.clear');
...
Route::get('/keranjang/pesan/{idProduk}', [AppController::class, 'pesan']);
    ...
    Route::group(['middleware' => ['can:super_admin']], function () {
        Route::prefix('super_admin')->group(function () {
            ...
            Route::prefix('master')->group(function () {
                ...
                Route::get('produk', [SuperAdminProdukController::class, 'index']);
                Route::get('karyawan', [SuperAdminKaryawanController::class, 'index']);
            });
